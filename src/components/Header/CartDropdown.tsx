...
import { useCart } from "../../containers/ProductDetailPage/CartContext"; // Assuming your CartContext is located in a file called CartContext
import { Link } from "react-router-dom";
import ButtonPrimary from "shared/Button/ButtonPrimary";
import ButtonSecondary from "shared/Button/ButtonSecondary";
import { CartItem } from "../../containers/ProductDetailPage/CartContext";
                    ...
                    <div className="relative bg-white dark:bg-neutral-800">
                      <div className="max-h-[60vh] p-5 overflow-y-auto hiddenScrollbar">
                        ...
                        <div className="divide-y divide-slate-100 dark:divide-slate-700">
                          {cart.length > 0 ? (
                              cart.map((item, index) => renderProduct(item, index, close))
                          ) : (
                      ...
                      {/*/!*  </span>*!/*/}
                      {/*/!*</span>*!/*/}
                      {/*    /!* Example total calculation, replace it with your real calculation *!/*/}
